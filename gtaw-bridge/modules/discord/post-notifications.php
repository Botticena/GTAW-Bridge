                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            ...
                            <div class="notification-settings">
                                ...
                                <?php if ($notification['post_type'] === 'post' || $notification['post_type'] === 'product'): ?>
                                    <div style="margin-bottom: 15px; border: 1px solid #ddd; padding: 10px; background: #f5f5f5;">
                                ...
                                <div style="margin-bottom: 15px;">
                                    ...
                                    <div style="margin-bottom: 10px;">
                                        ...
                                        <input type="color" name="gtaw_discord_post_notifications[<?php echo esc_attr($id); ?>][color]" value="<?php echo esc_attr(isset($notification['color']) ? $notification['color'] : '#5865F2'); ?>">
                                    </div>
                                    
                                    <div style="margin-bottom: 10px;">
                                        <label style="display: block; font-weight: bold; margin-bottom: 5px;">Description Content</label>
                                        <select name="gtaw_discord_post_notifications[<?php echo esc_attr($id); ?>][description_type]" style="width: 100%;">
                                    ...
                                    <div style="margin-bottom: 10px;">
                                        <label style="display: flex; align-items: center;">
                                            <input type="checkbox" name="gtaw_discord_post_notifications[<?php echo esc_attr($id); ?>][include_thumbnail]" value="1" <?php checked(isset($notification['include_thumbnail']) ? $notification['include_thumbnail'] : true); ?>>
                                ...
                                <div style="margin-bottom: 15px;">
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                                        <label style="display: flex; align-items: center;">
                                            <input type="checkbox" name="gtaw_discord_post_notifications[<?php echo esc_attr($id); ?>][show_category]" value="1" <?php checked(isset($notification['show_category']) ? $notification['show_category'] : true); ?>>
                                            <span style="margin-left: 5px;">Categories</span>
                                        </label>
                                        
                                        <label style="display: flex; align-items: center;">
                                            <input type="checkbox" name="gtaw_discord_post_notifications[<?php echo esc_attr($id); ?>][show_tags]" value="1" <?php checked(isset($notification['show_tags']) ? $notification['show_tags'] : true); ?>>
                                            <span style="margin-left: 5px;">Tags</span>
                                        </label>
                                        
                                        <label style="display: flex; align-items: center;">
                                            <input type="checkbox" name="gtaw_discord_post_notifications[<?php echo esc_attr($id); ?>][show_author]" value="1" <?php checked(isset($notification['show_author']) ? $notification['show_author'] : true); ?>>
                                            <span style="margin-left: 5px;">Author</span>
                                        </label>
                                        
                                        <label style="display: flex; align-items: center;">
                                            <input type="checkbox" name="gtaw_discord_post_notifications[<?php echo esc_attr($id); ?>][show_date]" value="1" <?php checked(isset($notification['show_date']) ? $notification['show_date'] : true); ?>>
                                    ...
                                    <?php if ($notification['post_type'] === 'product'): ?>
                                        <div style="margin-top: 10px; border-top: 1px solid #ddd; padding-top: 10px;">
                                            ...
                                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                                                <label style="display: flex; align-items: center;">
                                                    <input type="checkbox" name="gtaw_discord_post_notifications[<?php echo esc_attr($id); ?>][show_price]" value="1" <?php checked(isset($notification['show_price']) ? $notification['show_price'] : true); ?>>
                                                    <span style="margin-left: 5px;">Price</span>
                                                </label>
                                                
                                                <label style="display: flex; align-items: center;">
                                                    <input type="checkbox" name="gtaw_discord_post_notifications[<?php echo esc_attr($id); ?>][show_sku]" value="1" <?php checked(isset($notification['show_sku']) ? $notification['show_sku'] : false); ?>>
                                                    <span style="margin-left: 5px;">SKU</span>
                                                </label>
                                                
                                                <label style="display: flex; align-items: center;">
                                                    <input type="checkbox" name="gtaw_discord_post_notifications[<?php echo esc_attr($id); ?>][show_stock]" value="1" <?php checked(isset($notification['show_stock']) ? $notification['show_stock'] : true); ?>>
                            ...
                            <div class="notification-preview">
                                ...
                                <div class="discord-embed-preview" style="border-left: 4px solid <?php echo esc_attr(isset($notification['color']) ? $notification['color'] : '#5865F2'); ?>; background: #36393f; color: #fff; padding: 12px 15px; border-radius: 0 3px 3px 0; font-family: Arial, sans-serif;">
                                    <!-- Title -->
                                    <div style="font-weight: bold; margin-bottom: 8px; font-size: 16px; color: white;">
                                        <?php echo esc_html(str_replace(['[post_type_label]', '[post_title]'], [$type_label, 'Sample Post Title'], isset($notification['title']) ? $notification['title'] : 'New [post_type_label]: [post_title]')); ?>
                                    </div>
                                    
                                    <!-- Description -->
                                    <?php if (isset($notification['description_type']) && $notification['description_type'] !== 'none'): ?>
                                        <div style="margin-bottom: 10px; font-size: 14px; color: #dcddde;">
                                            <?php if ($notification['description_type'] === 'excerpt' || $notification['description_type'] === 'both'): ?>
                                                <p>This is a sample post excerpt that provides a brief summary of the content.</p>
                                            <?php endif; ?>
                                            
                                            <?php if ($notification['description_type'] === 'content' || $notification['description_type'] === 'both'): ?>
                                                <p>This is a sample of the post content, truncated to a reasonable length for Discord embedding...</p>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
                                    
                                    <!-- Image -->
                                    <?php if (isset($notification['include_thumbnail']) && $notification['include_thumbnail']): ?>
                                    ...
                                    <?php 
                                    $has_fields = false;
                                    foreach (['show_category', 'show_tags', 'show_price', 'show_sku', 'show_stock'] as $field) {
                                    ...
                                    <div style="margin-top: 10px; display: grid; grid-template-columns: repeat(2, 1fr); gap: 8px; font-size: 14px;">
                                        <?php if (isset($notification['show_category']) && $notification['show_category']): ?>
                                        ...
                                        <?php if (isset($notification['show_tags']) && $notification['show_tags']): ?>
                                            <div style="margin-bottom: 6px;">
                                        ...
                                        <?php if ($notification['post_type'] === 'product'): ?>
                                            <?php if (isset($notification['show_price']) && $notification['show_price']): ?>
                                                <div style="margin-bottom: 6px;">
                                            ...
                                            <?php if (isset($notification['show_sku']) && $notification['show_sku']): ?>
                                                <div style="margin-bottom: 6px;">
                                            ...
                                            <?php if (isset($notification['show_stock']) && $notification['show_stock']): ?>
                                                <div style="margin-bottom: 6px;">
                                    ...
                                    <!-- Footer -->
                                    <?php if ((isset($notification['show_author']) && $notification['show_author']) || (isset($notification['show_date']) && $notification['show_date'])): ?>
                                        <div style="font-size: 12px; color: #dcddde; margin-top: 10px;">
                                            <?php 
                                            $footer_parts = [];
                                            if (isset($notification['show_author']) && $notification['show_author']) {
                                                $footer_parts[] = 'By: Sample Author';
                                            }
                                            if (isset($notification['show_date']) && $notification['show_date']) {
                                                $footer_parts[] = date('F j, Y');
                                            }
